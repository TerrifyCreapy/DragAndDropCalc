...
const RunTimeIcon:FC<IRunTimeIcon> = ({state}) => {
    return(
        <>
            <svg className={state? s.active: s.nonactive} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
